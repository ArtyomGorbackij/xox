...
{
    if (((pos1 == pos2 && pos2 == pos3 && pos3 == pos4 && pos4 == pos5)||(pos1 == pos6 && pos6 == pos11 && pos11 == pos16 && pos16 == pos21)||(pos1 == pos7 && pos7 == pos13 && pos13 == pos19 && pos19 == pos25)) && pos1 == 'X')
    {
    ...
    if (((pos5 == pos10 && pos10 == pos15 && pos15 == pos20 && pos20 == pos25)||(pos5 == pos9 && pos9 == pos13 && pos13 == pos17 && pos17 == pos21 ))&& pos5 == 'X')
    {
        vivod(pos1, pos2, pos3, pos4, pos5, pos6, pos7, pos8, pos9, pos10, pos11, pos12, pos13, pos14, pos15, pos16, pos17, pos18, pos19, pos20, pos21, pos22, pos23, pos24, pos25);
        cout << "X win";
        exit(9);
        ...
        if (((pos5 == pos10 && pos10 == pos15 && pos15 == pos20 && pos20 == pos25) || (pos5 == pos9 && pos9 == pos13 && pos13 == pos17 && pos17 == pos21))  && pos5 == 'O')
        {
            vivod(pos1, pos2, pos3, pos4, pos5, pos6, pos7, pos8, pos9, pos10, pos11, pos12, pos13, pos14, pos15, pos16, pos17, pos18, pos19, pos20, pos21, pos22, pos23, pos24, pos25);
            cout << "O win";
            exit(9);
...
int main()
{
    ...
    int s = 0, cell, i = 1, p1 = 0, p2 = 0, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19, p20, p21, p22, p23, p24, p25, p26 ;
