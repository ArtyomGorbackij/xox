#include <iostream>
using namespace std;
void map(char pos1, char pos2, char pos3, char pos4, char pos5, char pos6, char pos7, char pos8, char pos9)
{
    cout << "    1   2   3" << endl;
    cout << "  +---+---+---+" << endl;
...
{
    if ((pos1 == pos2 && pos2 == pos3 && pos1 == 'x')||(pos1 == pos5 && pos5 == pos9 && pos1 == 'x')||(pos1 == pos4 && pos4 == pos7 && pos1 == 'x')||(pos4 == pos5 && pos5 == pos6 && pos4 == 'x')||(pos7 == pos8 && pos8 == pos9 && pos7 == 'x')||(pos2 == pos5 && pos5 == pos8 && pos2 == 'x')||(pos3 == pos6 && pos6 == pos9 && pos3 == 'x')||(pos3 == pos5 && pos5 == pos7 && pos3 == 'x'))
    {
        map(pos1, pos2, pos3, pos4, pos5, pos6, pos7, pos8, pos9);
        cout << "X победили!\n";
        exit(9);
    }
    if ((pos1 == pos2 && pos2 == pos3 && pos1 == 'o')||(pos4 == pos5 && pos5 == pos6 && pos4 == 'o')||(pos7 == pos8 && pos8 == pos9 && pos7 == 'o')||(pos1 == pos4 && pos4 == pos7 && pos1 == 'o')||(pos2 == pos5 && pos5 == pos8 && pos2 == 'o')||(pos3 == pos6 && pos6 == pos9 && pos3 == 'o')||(pos1 == pos5 && pos5 == pos9 && pos1 == 'o')||(pos3 == pos5 && pos5 == pos7 && pos3 == 'o'))
    {
        map(pos1, pos2, pos3, pos4, pos5, pos6, pos7, pos8, pos9);
        cout << "O победили!\n";
        exit(9);
...
int main()
{
    ...
    int s = 0, cell, i = 0, p1 = 0, p2 = 0, p3 = 0, p4 = 0, p5 = 0, p6 = 0, p7 = 0, p8 = 0, p9 = 0, p10 ;
